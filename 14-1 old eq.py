                    ...
                    if event.type == pygame.KEYDOWN: # if the enter key is pressed
                        if event.key==pygame.K_RETURN:
                            ...
                            if x<350 and x>125 and y>125 and y<250:
                                print "uoioi"
                                instruction=Background(window,"striker.jpg")
                                window.blit(instruction.image,[300,300])
                                print "hi"
                    if event.type == pygame.KEYDOWN: # if the enter key is pressed
                        if event.key==pygame.K_RETURN:
                            x,y = pygame.mouse.get_pos()
...
options = [Option("INSTRUCTIONS", (125, 200),mediumfont),Option("CARROM BOARD", (400, 30),mediumfont), Option("SINGLE PLAYER", (125, 255),smallfont),
