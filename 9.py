...
#      
    ...
    def move(self,u,x,y): #for angles between self piece and onther piece which is colliding with it
        ...
        self.velocity=u*(self.cosX )#calculates the velocity of this stationar self piece due to collision with a moving particle
        if self.velocity>50:  
            self.velocity=0
                ...
                for event in pygame.event.get():
                    if event.type == pygame.KEYDOWN: # if the enter key is pressed
                        if event.key==pygame.K_RETURN:
                            ...
                            if x<350 and x>125 and y>200 and y<400:
                                intro=False
                                iscomputer=True
                    ...
                    if event.type == pygame.KEYDOWN: # if the enter key is pressed
                        if event.key==pygame.K_RETURN:
                            x,y = pygame.mouse.get_pos()
                            if x<350 and x>125 and y>400 and y<455:
                                intro=False
                                
                    if event.type == pygame.KEYDOWN: # if the enter key is pressed       
                        if event.key==pygame.K_RETURN:
                            x,y = pygame.mouse.get_pos()
                            if x<500 and x>125  and y>295 and y<450:
